...
-->
  <span class="vue-typer">
    <span class="left">
      <span v-for="l in numLeftChars"
        class="char custom typed"
        v-html="currentTextArray[l-1]"></span>
    </span>

    <caret :class="caretClasses" :animation="caretAnimation"></caret>

    <span class="right">
      <span v-for="r in numRightChars"
        class="char custom"
        :class="rightCharClasses"
        v-html="currentTextArray[numLeftChars + r-1]"></span>
    </span>
  </span>
</template>
...
<style>
  ...
  span.vue-typer span.char {
    white-space: nowrap;
  }
  span.vue-typer span.char:empty {
    width: 10em;
  }
